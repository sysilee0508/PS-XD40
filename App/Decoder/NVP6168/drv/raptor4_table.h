 ...
 *
 ********************************************************************************/
#ifndef _RAPTOR4_TABLE_
#define _RAPTOR4_TABLE_
...
#if 0
	/* Video Coax Table *********************/
	NC_U8 nc_table_coax_up01_mode_fmt[11];
	NC_U8 nc_table_coax_up02_line_pos_lsb[11];
	NC_U8 nc_table_coax_up03_line_pos_msb[11];
	NC_U8 nc_table_coax_up04_sync_pos_lsb[11];
	NC_U8 nc_table_coax_up05_sync_pos_msb[11];
	NC_U8 nc_table_coax_up06_data_width[11];
	NC_U8 nc_table_coax_up07_data_even[11];
	NC_U8 nc_table_coax_up08_data_zero_length[11];
	NC_U8 nc_table_coax_up09_shot_line_1frame[11];
	NC_U8 nc_table_coax_up10_shot_line_total[11];

	NC_U8 nc_table_coax_down01_common_on[11];      // 3x63
	NC_U8 nc_table_coax_down02_common_enhance[11]; // 3x66
	NC_U8 nc_table_coax_down03_mode_fmt[11];       // 3x61
	NC_U8 nc_table_coax_down04_line_pos[11];       // 3x62
	NC_U8 nc_table_coax_down05_data_width[11];     // 3x69
	NC_U8 nc_table_coax_down06_data_size[11];      // 3x61
	NC_U8 nc_table_coax_down07_data_header[11];    // 3x60
#endif

...
NC_VD_COAX_Init_STR coax_init_lists[]=
{
	...
	[ AHD30_5_3M_20P ] = {
		...
		.tx_cmd_addr       = 0x10,
		.tx_shot_addr      = 0x09,
		.tx_baud 		   = { 0x35, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_pel_baud 	   = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_pos0 	   = { 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_pos1 	   = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_count 	   = 0x07,
...
*/
		...
		.tx_line_count_max = 0x0E,
		.tx_mode 		   = 0x10,
		.tx_sync_pos0 	   = { 0x60, 0x00, 0x00, 0x00, 0x00, 0x00 }, // { 0xa0, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_sync_pos1 	   = { 0x03, 0x00, 0x00, 0x00, 0x00, 0x00 }, // { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_even 		   = 0x00,
		.tx_zero_length    = 0x00,
	...
	[ TVI_5M_20P ] = {
		...
		.tx_line_count_max = 0x02,
		.tx_mode 		   = 0x08,
		.tx_sync_pos0 	   = { 0xc0, 0x00, 0x00, 0xB0, 0x00, 0x00 },
		.tx_sync_pos1 	   = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_even 		   = 0x00,
		.tx_zero_length    = 0x00,

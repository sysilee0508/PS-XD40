...
video_equalizer_distance_table_s equalizer_distance_fmtdef[ NC_VIVO_CH_FORMATDEF_MAX ] =
{
		[ CVI_4M_30P ] = { /* o */
				{
					.hsync_stage[0] = 0x905D80,	/* short */
					.hsync_stage[1] = 0x8C7AEC,	/* 100m  */
					.hsync_stage[2] = 0x8925E7,	/* 200m  */
					.hsync_stage[3] = 0x85AB55,	/* 300m  */
					.hsync_stage[4] = 0x818457,	/* 400m  */
					.hsync_stage[5] = 0x3FA417,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ CVI_4M_25P ] = { /* o */
				{
					.hsync_stage[0] = 0x90350D,	/* short */
					.hsync_stage[1] = 0x8C3450,	/* 100m  */
					.hsync_stage[2] = 0x88F4C5,	/* 200m  */
					.hsync_stage[3] = 0x852DF6,	/* 300m  */
					.hsync_stage[4] = 0x8120F7,	/* 400m  */
					.hsync_stage[5] = 0x3F6097,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ CVI_FHD_30P ] = { /* x */
				{
					.hsync_stage[0] = 0x8E2706,	/* short */
					.hsync_stage[1] = 0x8BA94C,//0x8998C7,	/* 100m  */
					.hsync_stage[2] = 0x873b65,//0x853F26,	/* 200m  */
					.hsync_stage[3] = 0x808B11,	/* 300m  */
					.hsync_stage[4] = 0x7C0A59,	/* 400m  */
					.hsync_stage[5] = 0x3CAD92,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ CVI_FHD_25P ] = { /* x */
				{
					.hsync_stage[0] = 0x8FA61E,	/* short */
					.hsync_stage[1] = 0x8B76F4,//0x8A8BBD,	/* 100m  */
					.hsync_stage[2] = 0x8777ED,//0x85E6A9,	/* 200m  */
					.hsync_stage[3] = 0x80CDC6,	/* 300m  */
					.hsync_stage[4] = 0x7B0BFD,	/* 400m  */
					.hsync_stage[5] = 0x3C2B39,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ CVI_HD_30P ] = { /* o */
			{
				.hsync_stage[0] = 0x8F2DA4, /* short */
				.hsync_stage[1] = 0x8BE2E6, /* 100m  */
				.hsync_stage[2] = 0x888D9B, /* 200m  */
				.hsync_stage[3] = 0x849403, /* 300m  */
				.hsync_stage[4] = 0x80231A, /* 400m  */
				.hsync_stage[5] = 0x7B6E9A, /* 500m  */
		...
		[ CVI_HD_25P ] = { /* o */
			{
				.hsync_stage[0] = 0x8F0C01,	/* short */
				.hsync_stage[1] = 0x8BF196,	/* 100m  */
				.hsync_stage[2] = 0x89373E,	/* 200m  */
				.hsync_stage[3] = 0x85384B,	/* 300m  */
				.hsync_stage[4] = 0x803A33,	/* 400m  */
				.hsync_stage[5] = 0x7B4A16,	/* 500m  */
		...
		[ AHD30_4M_25P ] = { /* x */
				{
					.hsync_stage[0] = 0x34905F,	/* short */
					.hsync_stage[1] = 0x306A39,	/* 100m  */
					.hsync_stage[2] = 0x2D1AA7,	/* 200m  */
					.hsync_stage[3] = 0x291EB0,	/* 300m  */
					.hsync_stage[4] = 0x26737D,	/* 400m  */
					.hsync_stage[5] = 0x12CD1D,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ AHD30_4M_30P ] = { /* x */
				{
					.hsync_stage[0] = 0x34B258,	/* short */
					.hsync_stage[1] = 0x30B16D,	/* 100m  */
					.hsync_stage[2] = 0x2D4F8D,	/* 200m  */
					.hsync_stage[3] = 0x298569,	/* 300m  */
					.hsync_stage[4] = 0x26F1C1,	/* 400m  */
					.hsync_stage[5] = 0x12D84B,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ AHD30_4M_15P ] = { /* x */
				{
					.hsync_stage[0] = 0x333A76,	/* short */
					.hsync_stage[1] = 0x31CCB3,	/* 100m  */
					.hsync_stage[2] = 0x2F3FE7,	/* 200m  */
					.hsync_stage[3] = 0x2BFD44,	/* 300m  */
					.hsync_stage[4] = 0x2A9E90,	/* 400m  */
					.hsync_stage[5] = 0x14A636,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
	...
	[ AHD30_8M_15P ] = { /* x */
		...
		[ TVI_4M_25P ] = { /* x */
				{
					.hsync_stage[0] = 0x334E7D,	/* short */
					.hsync_stage[1] = 0x2FB52B,	/* 100m  */
					.hsync_stage[2] = 0x2C65A1,	/* 200m  */
					.hsync_stage[3] = 0x29B320,	/* 300m  */
					.hsync_stage[4] = 0x274D07,	/* 400m  */
					.hsync_stage[5] = 0x12F315,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ TVI_4M_30P ] = { /* x */
				{
					.hsync_stage[0] = 0x33D96B,	/* short */
					.hsync_stage[1] = 0x302EED,	/* 100m  */
					.hsync_stage[2] = 0x2C9231,	/* 200m  */
					.hsync_stage[3] = 0x29AA80,	/* 300m  */
					.hsync_stage[4] = 0x273CFC,	/* 400m  */
					.hsync_stage[5] = 0x130EB2,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ AHD30_5M_20P ] = { /* x */
				{
					.hsync_stage[0] = 0x90A62B,	/* short */
					.hsync_stage[1] = 0x8C731C,	/* 100m  */
					.hsync_stage[2] = 0x88624A,	/* 200m  */
					.hsync_stage[3] = 0x843216,	/* 300m  */
					.hsync_stage[4] = 0x817690,	/* 400m  */
					.hsync_stage[5] = 0x400897,	/* 500m  */
				},
				{
					.agc_stage[0]   = 0x00,
					.agc_stage[1]   = 0x00,
		...
		[ TVI_5M_12_5P ] = { /* o */
			{
				.hsync_stage[0] = 0x334B00,	/* short */
				.hsync_stage[1] = 0x2FE6C3,	/* 100m  */
				.hsync_stage[2] = 0x2CA3EE,	/* 200m  */
				.hsync_stage[3] = 0x299275,	/* 300m  */
				.hsync_stage[4] = 0x272B03,	/* 400m  */
				.hsync_stage[5] = 0x12FC4A,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
		...
		[ AHD20_1080P_25P ] = { /* o */
			{
				.hsync_stage[0] = 0x8F507D,	/* short */
				.hsync_stage[1] = 0x8C9490,	/* 100m  */
				.hsync_stage[2] = 0x89916A,	/* 200m  */
				.hsync_stage[3] = 0x8672e5,	/* 300m  */
				.hsync_stage[4] = 0x8385e0,	/* 400m  */
				.hsync_stage[5] = 0x40FAF1,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
		...
		[ AHD20_1080P_30P ] = { /* o */
			{
				.hsync_stage[0] = 0x8EEE80,	/* short */
				.hsync_stage[1] = 0x8C5ED5,	/* 100m  */
				.hsync_stage[2] = 0x88EDFE,	/* 200m  */
				.hsync_stage[3] = 0x853280,	/* 300m  */
				.hsync_stage[4] = 0x817108,//0x828BE8	/* 400m  */
				.hsync_stage[5] = 0x3FD16C,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
		...
		[ TVI_FHD_30P ] = { /* o */
			{
				.hsync_stage[0] = 0x33C500,	/* short */
				.hsync_stage[1] = 0x2F6D72,	/* 100m  */
				.hsync_stage[2] = 0x2B9779,	/* 200m  */
				.hsync_stage[3] = 0x285237,	/* 300m  */
				.hsync_stage[4] = 0x2515F8,	/* 400m  */
				.hsync_stage[5] = 0x12030D,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
		...
		[ TVI_FHD_25P ] = { /* o */
			{
				.hsync_stage[0] = 0x3348CC,	/* short */
				.hsync_stage[1] = 0x2F6090,	/* 100m  */
				.hsync_stage[2] = 0x2B93F1,	/* 200m  */
				.hsync_stage[3] = 0x28E02F,	/* 300m  */
				.hsync_stage[4] = 0x25322C,	/* 400m  */
				.hsync_stage[5] = 0x1287BD,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
		...
		[ TVI_HD_B_30P_EX ] = { /* o */
			{
				.hsync_stage[0] = 0x323396,	/* short */
				.hsync_stage[1] = 0x2F5FBB,	/* 100m  */
				.hsync_stage[2] = 0x2CECA6,	/* 200m  */
				.hsync_stage[3] = 0x29E053,	/* 300m  */
				.hsync_stage[4] = 0x27D18C,	/* 400m  */
				.hsync_stage[5] = 0x25A6A1,	/* 500m  */
		...
		[ TVI_HD_B_25P_EX ] = { /* o */
			{
				.hsync_stage[0] = 0x323987,	/* short */
				.hsync_stage[1] = 0x2F674F,	/* 100m  */
				.hsync_stage[2] = 0x2D1F40,	/* 200m  */
				.hsync_stage[3] = 0x2A6D80,	/* 300m  */
				.hsync_stage[4] = 0x280AF4,	/* 400m  */
				.hsync_stage[5] = 0x26426E,	/* 500m  */
		...
		[ AHD30_5M_12_5P ] = { /* x */
			{
				.hsync_stage[0] = 0x8F84CF,	/* short */
				.hsync_stage[1] = 0x8D9995,	/* 100m  */
				.hsync_stage[2] = 0x8B2682,	/* 200m  */
				.hsync_stage[3] = 0x8789BD,	/* 300m  */
				.hsync_stage[4] = 0x84BF87,	/* 400m  */
				.hsync_stage[5] = 0x409D84,	/* 500m  */
			},
			{
				.agc_stage[0]   = 0x00,
				.agc_stage[1]   = 0x00,
...
/*B0 0x64*/ .v_delay[0]     = 0x80, .v_delay[1]     = 0x80, .v_delay[2]     = 0x80, .v_delay[3]     = 0x80, .v_delay[4]     = 0x80, .v_delay[5]     = 0x80,
	...
	/*B0 0x64*/ .v_delay[0]     = 0x80, .v_delay[1]     = 0x80, .v_delay[2]     = 0x80, .v_delay[3]     = 0x80, .v_delay[4]     = 0x80, .v_delay[5]     = 0x80,
...
#else	
		{
			...
			/* color */
			{
				.contrast[0] 		= 0x86, .contrast[1] 		= 0x88, .contrast[2] 		= 0x8a, .contrast[3] 		= 0x8a, .contrast[4] 		= 0x8a, .contrast[5] 		= 0x8a,
				.h_peaking[0] 		= 0x10, .h_peaking[1] 		= 0x10, .h_peaking[2] 		= 0x10, .h_peaking[3] 		= 0x00, .h_peaking[4] 		= 0x30, .h_peaking[5] 		= 0x20,
				.c_filter[0]		= 0x81, .c_filter[1] 		= 0x82, .c_filter[2]	 	= 0x92, .c_filter[3] 		= 0x92, .c_filter[4] 		= 0xc4, .c_filter[5] 		= 0xc4,
				...
				.black_level[0] 	= 0x84, .black_level[1] 	= 0x84, .black_level[2] 	= 0x85, .black_level[3] 	= 0x88, .black_level[4] 	= 0x8a, .black_level[5] 	= 0x8c,
				.acc_ref[0]			= 0x57, .acc_ref[1]			= 0x57, .acc_ref[2]			= 0x57, .acc_ref[3]			= 0x57, .acc_ref[4]			= 0x47, .acc_ref[5]			= 0x37,
				.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0xa0, .cti_delay[5]		= 0x80,
				.sub_saturation[0] 	= 0xd0, .sub_saturation[1] 	= 0xe0, .sub_saturation[2] 	= 0xe0, .sub_saturation[3] 	= 0x9c, .sub_saturation[4] 	= 0x00, .sub_saturation[5] 	= 0xa0,
			...
			{
				.h_delay_a[0] = 0x80, .h_delay_a[1] = 0x80, .h_delay_a[2] = 0x7e, .h_delay_a[3] = 0x7e, .h_delay_a[4] = 0x7e, .h_delay_a[5] = 0x7e,
				.h_delay_b[0] = 0x00, .h_delay_b[1] = 0x00, .h_delay_b[2] = 0x00, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
				.h_delay_c[0] = 0x00, .h_delay_c[1] = 0x02, .h_delay_c[2] = 0x02, .h_delay_c[3] = 0x02, .h_delay_c[4] = 0x02, .h_delay_c[5] = 0x02,
				.y_delay[0]   = 0x00, .y_delay[1]   = 0x00, .y_delay[2]   = 0x00, .y_delay[3]   = 0x00, .y_delay[4]   = 0x00, .y_delay[5] = 0x00,
	...
	/*B9 0x9e*/ .h_scaler9[0]	= 0x0f, .h_scaler9[1]	= 0x0f, .h_scaler9[2]	= 0x0f, .h_scaler9[3]	= 0x0f, .h_scaler9[4]	= 0x0f, .h_scaler9[5]	= 0x0f,
			...
			[ TVI_8M_12_5P ] = { /* o */
				...
				/* color */
				{
					...
					.burst_dec_a[0] 	= 0x2a, .burst_dec_a[1] 	= 0x2a, .burst_dec_a[2] 	= 0x2a, .burst_dec_a[3] 	= 0x2a, .burst_dec_a[4] 	= 0x2a, .burst_dec_a[5] 	= 0x2a,
					.burst_dec_b[0] 	= 0x00, .burst_dec_b[1] 	= 0x00, .burst_dec_b[2] 	= 0x00, .burst_dec_b[3] 	= 0x00, .burst_dec_b[4] 	= 0x00, .burst_dec_b[5] 	= 0x00,
					.burst_dec_c[0] 	= 0x10, .burst_dec_c[1] 	= 0x10, .burst_dec_c[2] 	= 0x10, .burst_dec_c[3] 	= 0x10, .burst_dec_c[4] 	= 0x10, .burst_dec_c[5] 	= 0x10,

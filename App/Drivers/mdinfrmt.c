...
*/
	...
	{	// 720x480i60  (BT656)	//by hungry 2012.03.19
		  20,		// hdpulse_pos
		   8,		// vdpulse_pos
		 270,	// vdpulse_pos_bot
		 858,	// htotal_size
//		  103,		// hactive_start	   //hactive : 103-822, by hungry 2012.03.12
//		 823,	// hactive_end			   
		  87,		// hactive_start	   //hactive : 87-807, by hungry 2012.03.21 for CVBS out
		 807,	// hactive_end			   
		  63,		// hsync_start
		   1,		// hsync_end
		 525,	// vtotal_size
		  20,		// vactive_start	   //vactive : 20-263, by hungry 2012.03.19
		 264,	// vactive_end			  
		   7,		// vsync_start		   //vsync : 4-6, by hungry 2012.03.19
		   4,		// vsync_end		   
		 283,	// vactive_start_bot	   //vactive(bot) : 283-525, by hungry 2012.03.19
		 1,		// vactive_end_bot		   
		 269,	// vsync_start_bot		   //vsync(bot) : 266-269, by hungry 2012,03.19
		 266,	// vsync_end_bot		   
		 430,	// vsync_bot_fld_pos
...
/*		//by hungry 2012.03.19
	{	// 1280x720p24
		  ...
		  10,		// vdpulse_pos
		   0,		// vdpulse_pos_bot
		3300,	// htotal_size
//		4125,	// htotal_size			   //by hungry 2012.03.16
		 228,		// hactive_start
		1508,		// hactive_end
		  41,		// hsync_start
		   1,		// hsync_end
...
//		   6,		// pre_div_vclk (P)		//by hungry 2012.03.19
//		  66,		// post_div_vclk (M)	//by hungry 2012.03.19
//		   5,		// post_scale_vclk (S)	//by hungry 2012.03.19
		   4,		// pre_div_vclk (P)		//by hungry 2012.03.19
		  22,		// post_div_vclk (M)	//by hungry 2012.03.19
		   2,		// post_scale_vclk (S)	//by hungry 2012.03.19
...
//	 Htot					                   H/V Polarity & ScanType                                       Hact  Vact
	...
	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_INTR,  960*2,  480},	// 960x480i60
	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_INTR,  960*2,  576},	// 960x576i50
...
//	{1144, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG,  960*2,  480/2},	// 960x480i60
//	{1200, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG,  960*2,  576/2},	// 960x576i50
#else
...
//	{3300, MDIN_POSITIVE_HACT|MDIN_POSITIVE_VACT|MDIN_POSITIVE_HSYNC|MDIN_POSITIVE_VSYNC|MDIN_SCANTYPE_PROG, 1280,  720},		// 1280x720p24			//by hungry 2012.03.19
...
//	{{ 60,  0, 0, (2<<4)|0}, { 5940,  2400, 3300,  750}, {260,  25, 1280,  720}, {0,  40, 5, 220,  20, 1760,  5,    0}}, // 1280x720p@24(60)   //by hungry 2012.03.19
	
	{{  5,  0, 0, (2<<4)|0}, { 7418,  6000, 2200, 1125}, {192,  20, 1920,  540}, {3,  44, 5, 148,  15,  88,  2, 1100}}, // 1920x1080i@60(5)
	{{  5,  0, 0, (2<<4)|0}, { 7425,  5994, 2200, 1125}, {192,  20, 1920,  540}, {3,  44, 5, 148,  15,  88,  2, 1100}}, // 1920x1080i@59.94(5)

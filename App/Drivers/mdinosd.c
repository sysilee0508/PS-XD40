...
//--------------------------------------------------------------------------------------------------------------------------
static MDIN_ERROR_t MDINOSD_SpriteDisplay(PSPRITE_CTL_INFO pINFO, BYTE nID) //스프라이트 ON/OFF 설정
{
...
//--------------------------------------------------------------------------------------------------------------------------
MDIN_ERROR_t MDINOSD_EnableSprite(PSPRITE_CTL_INFO pINFO, BOOL OnOff) //스프라이트 ON/OFF 지정
{

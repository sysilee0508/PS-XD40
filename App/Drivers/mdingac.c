...
//#define GET_MDIN_IRQ() 0// is GPIO(IN)/IRQ pin of CPU. This is connected to INT_OUT of MDIN3xx.
...
MDIN_ERROR_t MDINGAC_SetDrawXYMode(WORD y, WORD x, PBYTE pBuff, WORD len, BYTE attb)
{
	WORD i, pChar[200]; //pChar[100];
	WORD posix, posiy;

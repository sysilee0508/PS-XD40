...
#if 0
	I2CWrite(VS4210_ADDR, 0x01 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x02 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x03 ,0x75) ;
	I2CWrite(VS4210_ADDR, 0x04 ,0x18) ;
	I2CWrite(VS4210_ADDR, 0x05 ,0x80) ;
	I2CWrite(VS4210_ADDR, 0x06 ,0x20) ;
	I2CWrite(VS4210_ADDR, 0x07 ,0x0C) ;
	I2CWrite(VS4210_ADDR, 0x08 ,0x20) ;
	I2CWrite(VS4210_ADDR, 0x09 ,0x0A) ;
	I2CWrite(VS4210_ADDR, 0x0A ,0x20) ;
	I2CWrite(VS4210_ADDR, 0x0B ,0x0A) ;
	I2CWrite(VS4210_ADDR, 0x0C ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x0D ,0x20) ;
	I2CWrite(VS4210_ADDR, 0x0E ,0x10) ;
	I2CWrite(VS4210_ADDR, 0x0F ,0x00) ;

	I2CWrite(VS4210_ADDR, 0x10 ,0x80) ;	
	I2CWrite(VS4210_ADDR, 0x11 ,0x83) ;
	I2CWrite(VS4210_ADDR, 0x12 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x13 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x14 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x15 ,0x88) ;
	I2CWrite(VS4210_ADDR, 0x16 ,0x01) ;
	I2CWrite(VS4210_ADDR, 0x17 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x18 ,0xC0) ;
	I2CWrite(VS4210_ADDR, 0x19 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x1A ,0x24) ;
	I2CWrite(VS4210_ADDR, 0x1B ,0x30) ;
	I2CWrite(VS4210_ADDR, 0x1C ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x1D ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x1E ,0x20) ;
	I2CWrite(VS4210_ADDR, 0x1F ,0x00) ;
	
	I2CWrite(VS4210_ADDR, 0x20 ,0x00) ;	
	I2CWrite(VS4210_ADDR, 0x21 ,0x00) ;
	I2CWrite(VS4210_ADDR, 0x22 ,0x) ;
	I2CWrite(VS4210_ADDR, 0x23 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x24 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x25 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x26 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x27 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x28 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x29 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x2F ,0x5A) ;	

	I2CWrite(VS4210_ADDR, 0x30 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x31 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x32 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x33 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x34 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x35 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x36 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x37 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x38 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x39 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x3F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0x40 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x41 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x42 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x43 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x44 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x45 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x46 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x47 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x48 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x49 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x4F ,0x5A) ;	

	I2CWrite(VS4210_ADDR, 0x50 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x51 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x52 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x53 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x54 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x55 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x56 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x57 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x58 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x59 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x5F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0x60 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x61 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x62 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x63 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x64 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x65 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x66 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x67 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x68 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x69 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x6F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0x70 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x71 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x72 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x73 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x74 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x75 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x76 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x77 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x78 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x79 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x7F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0x80 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x81 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x82 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x83 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x84 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x85 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x86 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x87 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x88 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x89 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x8F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0x90 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0x91 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x92 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x93 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x94 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x95 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x96 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x97 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x98 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x99 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9A ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9B ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9C ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9D ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9E ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0x9F ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xA0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xA1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xA9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAD ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xAF ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xB0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xB1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xB9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBD ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xBF ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xC0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xC1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xC9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCD ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xCF ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xD0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xD1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xD9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDD ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xDF ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xE0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xE1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xE9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xEA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xEB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xEC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xED ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xEE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xEF ,0x5A) ;

	I2CWrite(VS4210_ADDR, 0xF0 ,0x5A) ;	
	I2CWrite(VS4210_ADDR, 0xF1 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF2 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF3 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF4 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF5 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF6 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF7 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF8 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xF9 ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFA ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFB ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFC ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFD ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFE ,0x5A) ;
	I2CWrite(VS4210_ADDR, 0xFF ,0x5A) ;
#endif

...
static void MDIN3xx_SetRegInitial_C(void)
{
	...
	MDIN3xx_EnableIRQ(MDIN_IRQ_VSYNC_PULSE, ON); 	//kukuri
	...
	switch(src)
	{
		case VIDEO_DIGITAL_NVP6158_A:
				...
				(SrcMainFrmt[MDIN_ID_A] == VIDSRC_1280x720p60))
			{
				if((IS_FULL_MODE(displayMode) == TRUE) || (IS_PIP_MODE(displayMode) == TRUE))
				{
					...
					{
						OutMainFrmt[MDIN_ID_A] = VIDOUT_1920x1080p30;
						SrcMainFrmt[MDIN_ID_C] = VIDSRC_1920x1080p60;
					}
				}
				else
				{
					OutMainFrmt[MDIN_ID_A] = VIDOUT_1920x1080p60;
					SrcMainFrmt[MDIN_ID_C] = VIDSRC_1920x1080p60;
				}
				//SrcMainFrmt[MDIN_ID_C] = VIDSRC_1920x1080p60;
			...
			else
			{
				if((IS_FULL_MODE(displayMode) == TRUE) || (IS_PIP_MODE(displayMode) == TRUE))
				{
					if(SrcMainFrmt[MDIN_ID_A] == VIDSRC_960x576i50)
					{
						OutMainFrmt[MDIN_ID_A] = VIDOUT_1280x720p50;// VIDOUT_1280x720p60;
						SrcMainFrmt[MDIN_ID_C] = VIDSRC_1280x720p50;
					}
					else
					{
						OutMainFrmt[MDIN_ID_A] = VIDOUT_1920x1080p25;// VIDOUT_1280x720p60;
						SrcMainFrmt[MDIN_ID_C] = VIDSRC_1920x1080p50;
					}
				}
				else
				{
		...
		case VIDEO_DIGITAL_NVP6158_B:
			...
			else
			{
				if((IS_FULL_MODE(displayMode) == TRUE) || (IS_PIP_MODE(displayMode) == TRUE))
				{
					if(SrcMainFrmt[MDIN_ID_B] == VIDSRC_960x576i50)
					{
...
void CreateDisplayWindow_B(eDisplayMode_t displayMode)
{
	...
	switch(displayMode)
	{
		...
		case DISPLAY_MODE_4SPLIT_D3SCALE:
		case DISPLAY_MODE_4SPLIT_D3CROP:
			pMainView->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720 / 2;
			pMainView->h = DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720 / 2;
			pMainView->x = 0;
			pMainView->y = 0;

			pAuxView->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720 / 2;
			pAuxView->h =  DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720 / 2;
			pAuxView->x = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720 / 2;
			pAuxView->y = 0;
			break;
		...
		case DISPLAY_MODE_4SPLIT_QUAD:
			...
			pAuxView->h =  DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720 / 2;
			pAuxView->x = 0;
			pAuxView->y =  DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720 / 2;
			break;
			
		case DISPLAY_MODE_4SPLIT_H:	
			pMainView->w = DISPLAY_WIDTH/4;//DISPLAY_WIDTH_1280x720 / 4;
			pMainView->h = DISPLAY_HEIGHT;//DISPLAY_HEIGHT_1280x720;
			pMainView->x = 0;
			pMainView->y = 0;
			...
			pAuxView->w =  DISPLAY_WIDTH/4;//DISPLAY_WIDTH_1280x720 / 4;
			pAuxView->h = DISPLAY_HEIGHT;//DISPLAY_HEIGHT_1280x720;
			pAuxView->x =  DISPLAY_WIDTH*3/4;//DISPLAY_WIDTH_1280x720*3/4;
			pAuxView->y = 0;
		...
		case DISPLAY_MODE_4SPLIT_X:
			pMainView->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720/2;
			pMainView->h = DISPLAY_HEIGHT / 8;//DISPLAY_HEIGHT_1280x720/8;
			pMainView->x = 0;
			pMainView->y = 0;
			...
			pAuxView->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720/2;
			pAuxView->h = DISPLAY_HEIGHT / 8;//DISPLAY_HEIGHT_1280x720/8;
			pAuxView->x = 0;
			pAuxView->y = DISPLAY_HEIGHT*3 / 8;//DISPLAY_HEIGHT_1280x720*3/8;
...
void CreateDisplayWindow_C(eDisplayMode_t displayMode)
{
	...
	switch(displayMode)
	{
		...
		case DISPLAY_MODE_4SPLIT_QUAD:
			...
			pAuxCrop->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720/2;
			pAuxCrop->h = DISPLAY_HEIGHT;//DISPLAY_HEIGHT_1280x720;
			pAuxCrop->x = 0;
			pAuxCrop->y = 0;
			break;
		...
		case DISPLAY_MODE_4SPLIT_D3CROP:
			...
			pAuxCrop->w = DISPLAY_WIDTH;//DISPLAY_WIDTH_1280x720;
			pAuxCrop->h = DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720/2;
			pAuxCrop->x = 0;
			pAuxCrop->y = 0;
			break;
		...
		case DISPLAY_MODE_4SPLIT_X:
			pMainCrop->w = DISPLAY_HALF_WIDTH;//DISPLAY_WIDTH_1280x720/2;
			pMainCrop->h = DISPLAY_HALF_HEIGHT;//DISPLAY_HEIGHT_1280x720/2;
			pMainCrop->x = 0;
			pMainCrop->y = 0;
...
void SetInputChanged(MDIN_VIDEO_INPUT_t inputSource)
{
	...
	switch(inputSource)
	{
		case VIDEO_DIGITAL_NVP6158_AB:
			...
			break;
		case VIDEO_DIGITAL_NVP6158_A:
			stVideo[MDIN_ID_A].exeFLAG = MDIN_UPDATE_ALL;
			stVideo[MDIN_ID_B].exeFLAG = MDIN_UPDATE_CLEAR;
			break;
		case VIDEO_DIGITAL_NVP6158_B:
			stVideo[MDIN_ID_A].exeFLAG = MDIN_UPDATE_CLEAR;
			stVideo[MDIN_ID_B].exeFLAG = MDIN_UPDATE_ALL;
			break;
	}

...
#ifdef __9CH__
#define KEY_CS_HIGH		GPIOB->BSRR = 0x00000020 	//PB5
#define KEY_CS_LOW		GPIOB->BRR  = 0x00000020 	

#define KEY_CLK_HIGH	GPIOB->BSRR = 0x00000010 	//PB4
#define KEY_CLK_LOW		GPIOB->BRR  = 0x00000010 	

#define KEY_MOSI_HIGH	GPIOB->BSRR = 0x00000008 	//PB3
#define KEY_MOSI_LOW	GPIOB->BRR  = 0x00000008 	

#define KEY_MISO_INPUT 	(GPIOB->IDR & 0x00000002)	//PB1
#endif
...
//#define MDIN3xx_ADDR_DATA_INPUT_MODE  	GPIOA->CRH = 0x88888888; GPIOA->CRL = 0x88888888	//pull-up, pull-down

//#define KEY1_INPUT 		GPIOB->IDR & 0x00000040
//#define KEY2_INPUT 		GPIOB->IDR & 0x00000080
//#define KEY_INPUT 		GPIOB->IDR & 0x000000C0
